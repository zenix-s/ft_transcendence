...
function updateUserName() {
    setTimeout(() => {
        ...
        // Char counter
        const usernameInput = userNamerForm.querySelector<HTMLInputElement>(
            'input[name="username"]'
        );
      ...
      what it does: */
            try {
                ...
                const response = await fetch(
                    apiUrl('/user-manager/update-username'),
                    {
                        method: 'PATCH',
                        headers: {
    ...
    setTimeout(() => {
      ...
      what it does: */
            try {
                ...
                const response = await fetch(
                    apiUrl('/user-manager/update-password'),
                    {
                        // NEEDED UPDATE API ENDPOINT
                        method: 'PATCH',
                        headers: {
                            'Content-Type': 'application/json',
                            Authorization: `Bearer ${token}`,
