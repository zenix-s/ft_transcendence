...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    UserAvatarCreationError: "The avatar could not be created. Please try again later",
  ...
  es: {
    ...
    UserAvatarCreationError: "No se pudo crear el avatar. Por favor, inténtalo más tarde",
  ...
  fr: {
    ...
    UserAvatarCreationError: "Impossible de créer l'avatar. Veuillez réessayer ultérieurement.",
