...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    couldNotConnectToTheServer: "⚠️ Could not connect to the server",
  },
  es: {
    start: "Comenzar",
    game: "Juego",
    ...
    avatarElementsNotFound: "❌ Elementos del avatar uploader no encontrados en el DOM",
    ...
    couldNotConnectToTheServer: "⚠️ No se pudo conectar con el servidor",
  },
  fr: {
    start: "Démarrer",
    game: "Jeu",
    ...
    avatarElementsNotFound: "❌ Éléments d'avatar du téléchargeur introuvables dans le DOM",
    ...
    couldNotConnectToTheServer: "⚠️ Impossible de se connecter au serveur",
  },
};
